...
class Bodega(models.Model):
    ...
    def total_cant(self):
        return round(float(self.cantidad) + float(self.producto.cantidad), 2)

    def total_pvp(self):
        return round(float(self.cantidad) * float(self.costo), 2)
...
class Asistencia(models.Model):
    ...
    time_out = models.TimeField(("Hora salida"))
